...
import pickle
app= Flask(__name__)
model=pickle.load(open(r'C:\Users\Admin\Downloads\IBM-Project-52628-1661015389-main\IBM-Project-52628-1661015389-main\Final-Project\Project_demo\wqi.pkl','rb'))
@app.route('/')
def home() :
